import 'package:chocsarayi/api/deleteaddress.dart';
...
import 'package:chocsarayi/base/map_widget.dart';
                  ...
                  child: PopupMenuButton<String>(
                    ...
                    onSelected: (String result) {
                      if (result == 'delete') {
                        ...
                        // });
                        dodeleteaddress(addressModel.id.toString(), context);
                      } else {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => MainAddNewAddressScreen(isEnableUpdate: true, address: addressModel),
                        ));
                      }
                    },
                    itemBuilder: (BuildContext c) => <PopupMenuEntry<String>>[
                      PopupMenuItem<String>(
                        value: 'edit',
                        child: Text('تعديل', style: Theme.of(context).textTheme.headline2),
                      ),
                      PopupMenuItem<String>(
                        value: 'delete',
                        child: Text('حذف', style: Theme.of(context).textTheme.headline2),
                      ),
                    ],
                  ),
                )
