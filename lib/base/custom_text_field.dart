...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      inputFormatters: widget.inputType == TextInputType.phone ? <TextInputFormatter>[FilteringTextInputFormatter.allow(RegExp('[0-9+]'))] : widget.inputType==TextInputType.number?<TextInputFormatter>[
