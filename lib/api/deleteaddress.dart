...
Future<String> dodeleteaddress(String aid, BuildContext c)async {
  final CREATE_POST_URL = url+'api/general-deleteaddress';

  Post newPost = new Post(
    aid: aid,uid: user['userid']
  );
  print(newPost.toMap());
  ...
  if(body['status']=="success"){
    ...
    Navigator
        .of(c)
        .pushReplacement(new MaterialPageRoute(builder: (BuildContext context) =>AddressScreen()));
